...
class Migration(SchemaMigration):
  def forwards(self, orm):
    ...
    db.create_table('shop_division', (
      ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
      ('divisionName', self.gf('django.db.models.fields.CharField')(max_length=50)),
      ))
    db.send_create_signal('shop', ['Division'])

    # Adding field 'Product.division'
    db.add_column('shop_product', 'division',
      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Division'], null=True),
      keep_default=False)


  def backwards(self, orm):
    # Deleting model 'Division'
    db.delete_table('shop_division')

    # Deleting field 'Product.division'
    db.delete_column('shop_product', 'division_id')
