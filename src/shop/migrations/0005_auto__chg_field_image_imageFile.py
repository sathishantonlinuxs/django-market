...
class Migration(SchemaMigration):
  def forwards(self, orm):
    # Changing field 'Image.imageFile'
    db.alter_column('shop_image', 'imageFile', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

  def backwards(self, orm):
    # Changing field 'Image.imageFile'
    db.alter_column('shop_image', 'imageFile', self.gf('django.db.models.fields.files.FileField')(max_length=100))
