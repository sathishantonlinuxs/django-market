...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Image.imageCaption'
        db.add_column('shop_image', 'imageCaption',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.imageThumbnailFile'
        db.add_column('shop_image', 'imageThumbnailFile',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.imageThumbnailSquaredFile'
        db.add_column('shop_image', 'imageThumbnailSquaredFile',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Image.imageCaption'
        db.delete_column('shop_image', 'imageCaption')

        # Deleting field 'Image.imageThumbnailFile'
        db.delete_column('shop_image', 'imageThumbnailFile')

        # Deleting field 'Image.imageThumbnailSquaredFile'
        db.delete_column('shop_image', 'imageThumbnailSquaredFile')
    ...
    models = {
        ...
        'shop.image': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imageCaption': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'imageFile': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'imageThumbnailFile': ('django.db.models.fields.files.ImageField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'imageThumbnailSquaredFile': ('django.db.models.fields.files.ImageField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'})
        },
        'shop.label': {
        ...
        'shop.product': {
            ...
            'category': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['shop.Category']", 'symmetrical': 'False'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['shop.Label']", 'null': 'True', 'blank': 'True'}),
