...
class Migration(SchemaMigration):
  def forwards(self, orm):
    ...
    # Deleting field 'Image.path'
    db.delete_column('shop_image', 'path')

    # Deleting field 'Image.product'
    db.delete_column('shop_image', 'product_id')

    # Adding field 'Image.imageFile'
    db.add_column('shop_image', 'imageFile',
      self.gf('django.db.models.fields.files.FileField')(default=datetime.datetime(2012, 12, 27, 0, 0), max_length=100),
      keep_default=False)
  ...
  def backwards(self, orm):
    ...
    # Adding field 'Image.path'
    db.add_column('shop_image', 'path',
      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2012, 12, 27, 0, 0), max_length=200),
      keep_default=False)

    # Adding field 'Image.product'
    db.add_column('shop_image', 'product',
      self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2012, 12, 27, 0, 0),
        to=orm['shop.Product']),
      keep_default=False)

    # Deleting field 'Image.imageFile'
    db.delete_column('shop_image', 'imageFile')
  ...
  models = {
    ...
    'shop.image': {
      ...
      'productImage': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Product']", 'null': 'True'})
    },
    'shop.label': {
